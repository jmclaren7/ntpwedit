...
static struct DLG_Item Items[]=
    ...
    {&CtlLabel, ID_LABEL_COMPILED1, L"Compiled By John McLaren", 0, ID_GRP_VERSION, NULL},
    {&CtlLabel, ID_LABEL_COMPILED2, L"https://github.com/jmclaren7/ntpwedit", 0, ID_GRP_VERSION, URL_Proc},
